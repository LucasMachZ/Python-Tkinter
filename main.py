...
def onSelect(event):
    ...
    formItem = Frame(updateWindow)
    formItem.pack(side=TOP, pady=10)
    width = 400
    height = 300
    ...
    lbl_nome = Label(formItem, text='Nome', font=('arial', 12))
    lbl_nome.grid(row=0, sticky=W)
    lbl_telefone = Label(formItem, text='telefone', font=('arial', 12))
    lbl_telefone.grid(row=1, sticky=W)
    lbl_idade = Label(formItem, text='Idade', font=('arial', 12))
    lbl_idade.grid(row=2, sticky=W)
    lbl_email = Label(formItem, text='Email', font=('arial', 12))
    lbl_email.grid(row=3, sticky=W)
    lbl_endereco = Label(formItem, text='Endereco', font=('arial', 12))
    lbl_endereco.grid(row=4, sticky=W)
    lbl_av1 = Label(formItem, text='AV1', font=('arial', 12))
    lbl_av1.grid(row=5, sticky=W)
    lbl_av2 = Label(formItem, text='AV2', font=('arial', 12))
    lbl_av2.grid(row=6, sticky=W)
    lbl_av3 = Label(formItem, text='AV3', font=('arial', 12))
    lbl_av3.grid(row=7, sticky=W)
    lbl_avd = Label(formItem, text='AVD', font=('arial', 12))
    lbl_avd.grid(row=8, sticky=W)

    nomeEntry = Entry(formItem, textvariable=nome, font=('arial', 12))
    nomeEntry.grid(row=0, column=1)
    telefoneEntry = Entry(formItem, textvariable=telefone, font=('arial', 12))
    telefoneEntry.grid(row=1, column=1)
    idadeEntry = Entry(formItem, textvariable=idade, font=('arial', 12))
    idadeEntry.grid(row=2, column=1)
    emailEntry = Entry(formItem, textvariable=email, font=('arial', 12))
    emailEntry.grid(row=3, column=1)
    enderecoEntry = Entry(formItem, textvariable=endereco, font=('arial', 12))
    enderecoEntry.grid(row=4, column=1)
    av1Entry = Entry(formItem, textvariable=av1, font=('arial', 12))
    av1Entry.grid(row=5, column=1)
    av2Entry = Entry(formItem, textvariable=av2, font=('arial', 12))
    av2Entry.grid(row=6, column=1)
    av3Entry = Entry(formItem, textvariable=av3, font=('arial', 12))
    av3Entry.grid(row=7, column=1)
    avdEntry = Entry(formItem, textvariable=avd, font=('arial', 12))
    avdEntry.grid(row=8, column=1)

    bttn_updatecom = Button(formItem, text="Atualizar", width=50, command=updateData)
...
def insertData():
    ...
    bttn_submitcom = Button(formItem, text="Cadastrar", width=50, command=submitData)
